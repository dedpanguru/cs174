<?php
    ...
    require_once 'helpers.php'; // contains the SESSION_LIFETIME_IN_SECONDS constant, get_fatal_error_message, redirect, and sanitize functions
    ...
    if (isset($_POST['username']) && isset($_POST['password']))
    {
        ...
        if (isset($_POST['Register']) && $_POST['Register'] === 'true') // Register case
        {
            ...
            if (!$id_exists)
            {
                ...
                ($success) ? print "<h1 style='color:green'>Success! Log in to use the application</h1>" : die(get_fatal_error_message());
            }
        ...
        else if (isset($_POST['Login']) && $_POST['Login'] === 'true') // Login case
        {
            ...
            if ($creds->compare_password($input_password))
            {
                ...
                $_SESSION['username'] = $input_username; // only storing username since it is not as security critical as user id
